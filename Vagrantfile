...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "sobek-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/sobek"
  #   chef.validation_client_name = "sobek-validator"
  #   chef.validation_key_path = ".chef/sobek-validator.pem"
  # end
end
